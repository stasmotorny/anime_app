...
export type GetAnimeListQuery = { __typename?: 'Query', Page?: { __typename?: 'Page', media?: Array<{ __typename?: 'Media', id: number, type?: MediaType | null, status?: MediaStatus | null, seasonYear?: number | null, bannerImage?: string | null, genres?: Array<string | null> | null, popularity?: number | null, isFavourite: boolean, isFavouriteBlocked: boolean, title?: { __typename?: 'MediaTitle', english?: string | null } | null, coverImage?: { __typename?: 'MediaCoverImage', medium?: string | null } | null, relations?: { __typename?: 'MediaConnection', nodes?: Array<{ __typename?: 'Media', id: number, type?: MediaType | null, title?: { __typename?: 'MediaTitle', english?: string | null } | null } | null> | null } | null } | null> | null } | null };
...
export type GetMangaListQuery = { __typename?: 'Query', Page?: { __typename?: 'Page', media?: Array<{ __typename?: 'Media', id: number, type?: MediaType | null, status?: MediaStatus | null, seasonYear?: number | null, bannerImage?: string | null, genres?: Array<string | null> | null, popularity?: number | null, isFavourite: boolean, isFavouriteBlocked: boolean, title?: { __typename?: 'MediaTitle', english?: string | null } | null, coverImage?: { __typename?: 'MediaCoverImage', medium?: string | null } | null, relations?: { __typename?: 'MediaConnection', nodes?: Array<{ __typename?: 'Media', id: number, type?: MediaType | null, title?: { __typename?: 'MediaTitle', english?: string | null } | null } | null> | null } | null } | null> | null } | null };
...
export type GetUserCollectionQuery = { __typename?: 'Query', Page?: { __typename?: 'Page', media?: Array<{ __typename?: 'Media', id: number, type?: MediaType | null, status?: MediaStatus | null, seasonYear?: number | null, bannerImage?: string | null, genres?: Array<string | null> | null, popularity?: number | null, isFavourite: boolean, isFavouriteBlocked: boolean, title?: { __typename?: 'MediaTitle', english?: string | null } | null, coverImage?: { __typename?: 'MediaCoverImage', medium?: string | null } | null, nextAiringEpisode?: { __typename?: 'AiringSchedule', id: number, airingAt: number, episode: number } | null } | null> | null } | null };
 ...
 * });
 */
export function useGetAnimeListQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetAnimeListQuery, GetAnimeListQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return ApolloReactHooks.useQuery<GetAnimeListQuery, GetAnimeListQueryVariables>(GetAnimeListDocument, options);
      }
export function useGetAnimeListLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetAnimeListQuery, GetAnimeListQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return ApolloReactHooks.useLazyQuery<GetAnimeListQuery, GetAnimeListQueryVariables>(GetAnimeListDocument, options);
        }
export function useGetAnimeListSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<GetAnimeListQuery, GetAnimeListQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return ApolloReactHooks.useSuspenseQuery<GetAnimeListQuery, GetAnimeListQueryVariables>(GetAnimeListDocument, options);
        }
...
export const GetUserCollectionDocument = gql`
    query GetUserCollection($page: Int, $perPage: Int, $sortType: [MediaSort], $name: String, $genre: String, $status: MediaStatus, $startDate_greater: FuzzyDateInt, $startDate_lesser: FuzzyDateInt, $ids: [Int]) {
  Page(page: $page, perPage: $perPage) {
    media(
      sort: $sortType
      search: $name
 ...
 * });
 */
export function useGetUserCollectionQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetUserCollectionQuery, GetUserCollectionQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return ApolloReactHooks.useQuery<GetUserCollectionQuery, GetUserCollectionQueryVariables>(GetUserCollectionDocument, options);
      }
export function useGetUserCollectionLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetUserCollectionQuery, GetUserCollectionQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return ApolloReactHooks.useLazyQuery<GetUserCollectionQuery, GetUserCollectionQueryVariables>(GetUserCollectionDocument, options);
        }
export function useGetUserCollectionSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<GetUserCollectionQuery, GetUserCollectionQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return ApolloReactHooks.useSuspenseQuery<GetUserCollectionQuery, GetUserCollectionQueryVariables>(GetUserCollectionDocument, options);
        }
export type GetUserCollectionQueryHookResult = ReturnType<typeof useGetUserCollectionQuery>;
export type GetUserCollectionLazyQueryHookResult = ReturnType<typeof useGetUserCollectionLazyQuery>;
export type GetUserCollectionSuspenseQueryHookResult = ReturnType<typeof useGetUserCollectionSuspenseQuery>;
export type GetUserCollectionQueryResult = Apollo.QueryResult<GetUserCollectionQuery, GetUserCollectionQueryVariables>;