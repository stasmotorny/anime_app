  ...
  return (
    <ScrollView style={{flex: 1, backgroundColor: Colors.black}}>
      <GradientImageWithText
        ...
        score={data?.Media?.averageScore ? data.Media.averageScore.toString() : undefined}
        title={data?.Media?.title?.english}
      />
      <GenresList data={data?.Media?.genres} />
      <RatingBlock score={data?.Media?.averageScore ? data.Media.averageScore.toString() : undefined} />
